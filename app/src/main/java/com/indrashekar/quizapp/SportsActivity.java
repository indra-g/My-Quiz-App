...
public class SportsActivity extends AppCompatActivity {
        ...
        if (exit) {
            ...
            dialog.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    startActivity(new Intent(SportsActivity.this, StartActivity.class));
                    finish();
                }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String result=null;
        try {
            result= task.execute("https://opentdb.com/api.php?amount=10&category=21&difficulty=easy&type=multiple").get();
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
