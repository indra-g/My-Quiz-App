...
public class ComputerActivity extends AppCompatActivity {
    ...
    public void chooseanswer(View view){
        ...
        if(que==10){
            Intent intent=new Intent(ComputerActivity.this,ScoreActivity.class);
        ...
        if (exit) {
            ...
            dialog.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    startActivity(new Intent(ComputerActivity.this, StartActivity.class));
                    finish();
                }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String result=null;
        try {
            result= task.execute("https://opentdb.com/api.php?amount=10&category=18&difficulty=easy&type=multiple").get();
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
